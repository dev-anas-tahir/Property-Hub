...
class PropertyCardView(UnicornView):
    ...
    def load_property(self):
        ...
        self.property_data = {
            ...
            "description": (
                ...
                if len(property_obj.description) > 100
                else property_obj.description
            ),
    ...
    def property_favorited(self, property_id, is_favorited):
        logger.warning(
            f"property_card.py property_favorited called with property_id={property_id}, is_favorited={is_favorited}"
        )
